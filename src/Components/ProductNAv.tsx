    ...
    <div className='py-2 px-4 md:px-8 lg:px-14 md:flex justify-between items-center bg-gray-300 '>
      ...
      <div className='flex justify-between pt-2 pb-4 md:pb-0 md:pt-0 md:space-x-24'>
                ...
                <div className="relative w-full">
                    ...
                    <input type="text" id="search" className=" text-sm rounded-xl block w-48 lg:w-72  h-6 pl-10 p-2.5 py-4 bg-[#F5F5F5]  " placeholder="Search..." required onChange={(e) => setSearch(e.target.value.toLowerCase())}/>
                </div>
